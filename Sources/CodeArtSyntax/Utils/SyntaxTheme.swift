...
public struct SyntaxTheme {
    ...
    public static func standard() -> SyntaxTheme {
       return SyntaxTheme(
    ...
    public static func dracula() -> SyntaxTheme {
       return SyntaxTheme(
        linesCountColor: UIColor(hexString: "#ffffff", alpha: 0.7),
    ...
    public static func ayuLight() -> SyntaxTheme {
       return SyntaxTheme(
        linesCountColor: UIColor(hexString: "#37474f", alpha: 0.7),
    ...
    public static func ayuDark() -> SyntaxTheme {
       return SyntaxTheme(
    ...
    public static  func gravityLight() -> SyntaxTheme {
       return SyntaxTheme(
        linesCountColor: UIColor(hexString: "#37474f", alpha: 0.7),
        backgroundColor: UIColor(hexString: "#fafafa"),
        baseColor:  UIColor(hexString: "#202734"),
    ...
    public static func vsCodeLight() -> SyntaxTheme {
        return SyntaxTheme(
